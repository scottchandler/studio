...
LBP.prototype.drawProgressTimer = function() {
	...
	switch(this.options.defaultTimerFormat) {
		case "PASSED_REMAINING":
			timer.innerHTML = ((isNaN(this.html5Obj.duration)) ? "00:00" : LBP.parseTimer(passed));
			break;
		case "PASSED_HOVER_REMAINING":
			timer.innerHTML = ((isNaN(this.html5Obj.duration)) ? "" : LBP.parseTimer(passed));
				
			
			break;
		default:
			timer.innerHTML = (LBP.parseTimer(duration));
			break;
	}
};
